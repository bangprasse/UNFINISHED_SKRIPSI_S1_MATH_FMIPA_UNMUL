...
\input{konfigurasi/properti_dokumen}
...
% => Halaman Sampul Luar
\input{perangkat_skripsi/01_Sampul_Luar}
...
\input{perangkat_skripsi/02_Sampul_Dalam.tex}
...
\ifthenelse{\equal{\tahap}{semhas}}{
  % => Lembar pengesahan
  \input{perangkat_skripsi/04_Hal_Pengesahan}
  ...
  \ifthenelse{\equal{\tahap}{pendadaran}}{
    ...
    \ifthenelse{\equal{\tahap}{pengesahan}}{
      % => Lembar pernyataan
      \input{perangkat_skripsi/03_Hal_Pernyataan}
...
% => Halaman prakata
\input{perangkat_skripsi/07_Hal_Prakata}
...
\input{perangkat_skripsi/08_Daftar_Simbol}
% ------------------------------------------------------------------------
...
% => Bab 1
\input{badan_skripsi/01_Bab_1}

% => Bab 2
\input{badan_skripsi/02_Bab_2}

% => Bab 3
\input{badan_skripsi/03_Bab_3}
...
% => Daftar Pustaka
\input{perangkat_skripsi/09_Daftar_Pustaka}
