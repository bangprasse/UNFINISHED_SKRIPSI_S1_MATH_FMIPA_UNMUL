...
\vspace{-4mm}
{\frenchspacing
    Teknik sampling yang digunakan dalam penelitian ini adalah teknik \textit{total sampling}.
    Teknik \textit{total sampling} merupakan teknik penentuan sampel dengan memasukkan seluruh anggota populasi sebagai sampel yang digunakan \mycite{Zakaria:2018}.
