...
{\frenchspacing
    ...
    Berdasarkan data biaya \textit{talent} pada Tabel \ref{tab: data biaya talent} dan data talent yang bermain di setiap \textit{scene} pada \textbf{Lampiran 1},
    ...
    \begin{table}
        \centering
        \caption{Data Total Biaya Talent tiap Scene pada Film "Ketika Adzan Sudah Tidak Lagi Berkumandang"}
        \label{tab: biaya talent tiap scene}
        \begin{tabular}{|c|c|l|c|}
            \hline
            \textbf{No} & \textit{\textbf{Scene}}    & \textbf{Peran yang Bermain}                                                              & \textbf{Total Biaya \textit{Talent} (Rp)} \\ \hline
            1           & 1C                         & Irah, Manto, Wawan                                                                       & 97.647,058824                             \\ \hline
            2           & 1D                         &                                                                                          & 0                                         \\ \hline
            3           & 1E                         &                                                                                          & 0                                         \\ \hline
            4           & 2A                         & Irah, Manto, Wawan                                                                       & 97.647,058824                             \\ \hline
            5           & 2B                         & \begin{tabular}[c]{@{}l@{}}Irah, Manto, Wawan, \\ Ustadz Udas, Ismail, Mali\end{tabular} & 237.486,631016                            \\ \hline
            6           & 3                          & Irah, Manto, Wawan                                                                       & 97.647,058824                             \\ \hline
            7           & 4                          & Irah, Manto, Wawan                                                                       & 97.647,058824                             \\ \hline
            8           & 5                          & Wawan, Manto, Ustadz Udas                                                                & 66.274,509804                             \\ \hline
            \dots       & \multicolumn{1}{l|}{\dots} & \dots                                                                                    & \dots                                     \\ \hline
            59          & \multicolumn{1}{l|}{37}    & Ustadz Udas                                                                              & 35.294,117647                             \\ \hline
        \end{tabular}
    \end{table}
