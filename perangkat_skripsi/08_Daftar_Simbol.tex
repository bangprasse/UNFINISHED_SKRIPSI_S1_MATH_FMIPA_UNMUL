...
\begin{tabular}{lp{.75\textwidth}}
    ...
    $r_{2}^{(i)}$                   & Bilangan acak kedua berdistribusi \textit{unifrom} saat iterasi ke-$i$               \\
    ...
    $\boldsymbol{P}_{j,d}^{(i)}$    & Posisi terbaik partikel $j$ pada dimensi ke-$d$ saat iterasi ke-$i$                  \\
